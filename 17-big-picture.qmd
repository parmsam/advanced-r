...
- You can evaluation an expression using `base::eval()`. However, this requires an envrinoment where you tell R what the symbols in the expression mean.
...
- You can also also bind names to functions, allowing you to override the behaviour of existing functions.
